...
| PRD | `docs/prd/PRD-mfu-shuttle-bus-ai-base-passenger-counting-and-analysis.md` | |
...
|---|---|---|---|---|---|---:|---|---|---|---|---|---|
| mfu-shuttle-bus-ai-base-passenger-counting-and-analysis-TASK-001 | Source discovery | Orchestrator | AI | none | pending | 0 | not started | | | none | read source | T1-T4 evidence |
